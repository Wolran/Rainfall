...
int (*dword_8049830)(void) = NULL; // weak
FILE *stdout; // idb
...
int sub_8048390()
{
  return dword_8049830();
}
// 8049830: using guessed type int (*dword_8049830)(void);
...
// 8049750: using guessed type int _DTOR_LIST__[];
// 8049754: using guessed type int _DTOR_END__;
// 8049864: using guessed type char completed_6159;
// 8049868: using guessed type int dtor_idx_6161;
...
// 8049758: using guessed type int _JCR_LIST__;
...
void __cdecl _libc_csu_init(int a1, int a2, int a3)
{
  ...
  init_proc();
  v3 = (134518824 - (int)&GLOBAL_OFFSET_TABLE_) >> 2;
  if ( v3 )
  {
    for ( i = 0; i != v3; ++i )
...
// 8049748: using guessed type int _CTOR_LIST__[];
// 8049828: using guessed type Elf32_Dyn *GLOBAL_OFFSET_TABLE_;
